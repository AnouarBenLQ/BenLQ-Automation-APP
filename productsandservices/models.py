...
class Produit(models.Model):
    ...
    prix_1 = models.DecimalField(max_digits=10, decimal_places=2,verbose_name="Prix de Vente")
    prix_ttc_1 = models.DecimalField(max_digits=10, decimal_places=2,verbose_name="Prix de Vente TTC")
    prix_2 = models.DecimalField(max_digits=10, decimal_places=2,blank=True, null=True,verbose_name="Prix de Vente-2")
    prix_ttc_2 = models.DecimalField(max_digits=10, decimal_places=2,blank=True, null=True,verbose_name="Prix de Vente TTC-2")
    prix_3 = models.DecimalField(max_digits=10, decimal_places=2,blank=True, null=True,verbose_name="Prix de Vente-3")
    prix_ttc_3 = models.DecimalField(max_digits=10, decimal_places=2,blank=True, null=True,verbose_name="Prix de Vente TTC-3")
    prix_achat_net = models.DecimalField(max_digits=10, decimal_places=2,verbose_name="Prix d'achat")
