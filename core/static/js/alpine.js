        ...
        e.exports = (function () {
          ...
          function b(e, t, n) {
            ...
            if (r) {
              ...
              i = i.concat(
                Object.entries(n).map(([e, t]) => g({ name: e, value: t }))
              );
            }
          ...
          function W(e, t, n, i) {
            ...
            return (
              F(s) && s >= 0 && (s = Array.from(Array(s).keys(), (e) => e + 1)),
              s
            );
          }
          function K(e, t) {
          ...
          function re(e, t) {
            ...
            if (n.includes("debounce")) {
              ...
              n.splice(
                e,
                F((n[e + 1] || "invalid-wait").split("ms")[0]) ? 2 : 1
              );
            }
          ...
          class De {
            ...
            getOwnPropertyDescriptor(e, t) {
              ...
              const o = he(e, t);
              return Ee(o)
                ? ((s = Be(i, s, Pe)), s.configurable || fe(e, t, s), s)
                : o;
            }
            preventExtensions(e) {
            ...
            defineProperty(e, t, n) {
              ...
              return (
                fe(i, t, Ce(n)), !1 === o && fe(e, t, Be(r, n, Pe)), s(i, t), !0
              );
            }
          }
          function Te(e, t) {
          ...
          class Ke {
            ...
            registerListeners(e, t) {
              b(e, this).forEach(
                ({ type: n, value: i, modifiers: r, expression: s }) => {
                  switch (n) {
                    case "on":
                      te(this, e, i, r, s, t);
                      break;
            ...
            resolveBoundAttributes(e, t = !1, n) {
              let i = b(e, this);
              i.forEach(
                ({ type: r, value: s, modifiers: o, expression: a }) => {
                  switch (r) {
                    case "model":
